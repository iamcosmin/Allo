...
class _FluentSliverRefresh extends SingleChildRenderObjectWidget {
  const _FluentSliverRefresh({
    Key? key,
  ...
  // _RenderFluentSliverRefresh will paint the child in the available
  // space either way but this instructs the _RenderFluentSliverRefresh
  // on whether to also occupy any layoutExtent space or not.
  final bool hasLayoutExtent;

  @override
  _RenderFluentSliverRefresh createRenderObject(BuildContext context) {
    return _RenderFluentSliverRefresh(
  ...
  void updateRenderObject(
      BuildContext context, covariant _RenderFluentSliverRefresh renderObject) {
    renderObject
...
class _RenderFluentSliverRefresh extends RenderSliver
    with RenderObjectWithChildMixin<RenderBox> {
  _RenderFluentSliverRefresh({
...
/// the same values passed into the [FluentSliverRefreshControl].
///
...
/// A callback function that's invoked when the [FluentSliverRefreshControl] is
/// pulled a `refreshTriggerPullDistance`. Must return a [Future]. Upon
/// completion of the [Future], the [FluentSliverRefreshControl] enters the
...
///    [FluentSliverRefreshControl] is part of the scrollable and actively occupies
///    scrollable space.
class FluentSliverRefreshControl extends StatefulWidget {
  ...
  /// a refresh.
  const FluentSliverRefreshControl({
    Key? key,
  ...
  /// Retrieve the current state of the FluentSliverRefreshControl. The same as the
  ...
  static Widget _buildIndicatorForRefreshState(
    ...
    switch (refreshState) {
      ...
      case RefreshIndicatorMode.refresh:
        ...
        return Container(
            alignment: Alignment.center, height: 50, child: ProgressRing());
      case RefreshIndicatorMode.done:
        // When the user lets go, the standard transition is to shrink the spinner.
        return Container(
          alignment: Alignment.center,
          height: 100 * percentageComplete,
        );
  ...
  @override
  _FluentSliverRefreshControlState createState() =>
      _FluentSliverRefreshControlState();
}

class _FluentSliverRefreshControlState
    extends State<FluentSliverRefreshControl> {
